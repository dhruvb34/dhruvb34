...
////////
    public static void containsTest() {
        ...
        book.addSequence('!', new BinarySequence("0011"));
        book.addSequence('œ', new BinarySequence("0100"));
        System.out.println(book.contains('a'));            //
        System.out.println(book.contains('B'));            //
        System.out.println(book.contains(' '));            //
        System.out.println(book.contains('e'));           //
        System.out.println(book.contains('d'));           //
        System.out.println(book.contains('p'));           // true
        System.out.println(book.contains('l'));           // true
        System.out.println(book.contains('\0'));           // true
        System.out.println(book.contains('$'));           // true

//        book.showStructure();
        book = ProvidedHuffmanCodeBook.getEbookHuffmanCodebook();
//        book.showStructure();
...
////////
    ...
    public static void showEbookStructure(){
